...
st.title("🔍 TrueLens")
st.caption(
    "Can you trust your eyes anymore? Upload a photo and let TrueLens take a look. "
    f"Built on the pretrained model `{MODEL_ID}` — "
    "think of it as a second opinion, not a final verdict."
)
